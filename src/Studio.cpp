...
//    std::cout << "trainers.size() " << trainers.size() << std::endl;
//    std::cout << "Capacity " << trainers.at(1)->getCapacity() << std::endl;
//    for (int i = 0; i < workout_options.size(); i++) {
//        std::cout << "Name " << workout_options.at(i).getName() << std::endl;
//        std::cout << "type " << workout_options.at(i).getType() << std::endl;
//    }
